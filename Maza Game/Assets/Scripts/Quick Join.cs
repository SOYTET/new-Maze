...
{
    // Singleton
    public static QuickJoin _instance;
    public static QuickJoin Instance => _instance;

    public static bool isCreateMatch;
    public static bool isFoundMatch;
    ...
    //     {
    //        WinUI.winner = _joinData.PlayerName.ToString();
    //     }
    // }
    ...
    public async void FindMatch()
    {
        ...
        try
        {
            ...
            _joinData = new RelayJoinData
            {
                ...
                PlayerName = HomeManager.PlayerName.ToString()
            };
    ...
    private async void CreateMatch()
    {
        ...
        try
        {
            ...
            _hostData = new RelayHostData
            {
                ...
                ConnectionData = allocation.ConnectionData,
                IPv4Address = allocation.RelayServer.IpV4,
                PlayerName = HomeManager.PlayerName
            };
